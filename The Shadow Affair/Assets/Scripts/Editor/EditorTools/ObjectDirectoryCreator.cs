...
namespace SmugRag.Editor
{
    public class ObjectDirectoryCreator : EditorWindow
    {
        ...
        private string _pathToNewDirectory = "Assets/Graphics/_Objects";
        ...
        private bool _createDirectoryVFXs;
        private bool _createDirectoryShaders;

        #endregion Directories to create

        [MenuItem("SmugRag/Create/New Object Creator")]
        private static void Init()
        {
            ObjectDirectoryCreator window = (ObjectDirectoryCreator)EditorWindow.GetWindow(typeof(ObjectDirectoryCreator));
            window.Show();
        }
        ...
        private void OnGUI()
        {
            ...
            _createDirectoryVFXs = EditorGUILayout.Toggle("VFXs", _createDirectoryVFXs);
        ...
        private void CreateSubdirectories(string path)
        {
            ...
            if (_createDirectoryVFXs)
            {
                if (!CheckIfDirectoryAlreadyExists(path + "/" + "VFXs"))
                {
                    CreateNewDirectory(path, "VFXs");
                }
            }
